 ...
 */
router.get('/', authenticate, authorize('websiteAdmin', 'superadmin'), getAllUsers);
 ...
 *       - bearerAuth: []
 */
router.get('/:id', authenticate, authorize('websiteAdmin', 'superadmin'), getUserById);
router.put('/:id', authenticate, authorize('websiteAdmin', 'superadmin'), updateUser);
router.delete('/:id', authenticate, authorize('websiteAdmin', 'superadmin'), deleteUser);
