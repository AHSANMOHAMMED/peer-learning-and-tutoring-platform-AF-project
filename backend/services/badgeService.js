    ...
    try {
      const defaultBadges = [
        // Subject Mastery Badges
        {
          ...
          description: 'Earn 100 points in Combined Mathematics',
          icon: '🧮',
          category: 'subject_mastery',
          criteria: { type: 'points', value: 100, subject: 'Combined Mathematics' },
          pointsAwarded: 50,
          rarity: 'uncommon',
          tier: 1
        },
        {
          ...
          description: 'Earn 100 points in O/L General Science',
          icon: '🔬',
          category: 'subject_mastery',
          criteria: { type: 'points', value: 100, subject: 'O/L General' },
          pointsAwarded: 50,
          rarity: 'uncommon',
          tier: 1
        },
        {
          name: 'ICT Mastery',
          description: 'Earn 100 points in Computer Science and Technology',
          icon: '💻',
          category: 'subject_mastery',
          criteria: { type: 'points', value: 100, subject: 'Technology Stream' },
          pointsAwarded: 50,
          rarity: 'uncommon',
          tier: 1
        },
        {
          ...
          description: 'Earn 100 points in Physical Sciences',
          icon: '⚛️',
          category: 'subject_mastery',
          criteria: { type: 'points', value: 100, subject: 'Physical Sciences' },
          pointsAwarded: 50,
          rarity: 'uncommon',
          tier: 1
        },
        {
          ...
          description: 'Earn 100 points in Commercial Stream',
          icon: '🧪',
          category: 'subject_mastery',
          criteria: { type: 'points', value: 100, subject: 'Commercial Stream' },
          pointsAwarded: 50,
          rarity: 'uncommon',
          tier: 1
        },
        {
          name: 'Biological Specialist',
          description: 'Earn 100 points in Biological Sciences',
          icon: '🧬',
          category: 'subject_mastery',
          criteria: { type: 'points', value: 100, subject: 'Biological Sciences' },
          pointsAwarded: 50,
          rarity: 'uncommon',
          tier: 1
        },
