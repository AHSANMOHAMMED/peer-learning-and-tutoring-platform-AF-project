...
interface ParentQAForumProps {
  qaPerformance?: any;
  studentGrade?: string | number;
}

const ParentQAForum: React.FC<ParentQAForumProps> = ({ qaPerformance, studentGrade }) => {
    ...
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-br from-indigo-900 to-slate-900 rounded-[2rem] p-8 text-white shadow-xl relative overflow-hidden">
         ...
         <div className="relative z-10">
            <h3 className="text-3xl font-black tracking-tight mb-2">Community QA Forum</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                  ...
                  >
                     <div className="flex items-center gap-6">
                        ...
                        <div>
                           ...
                           <p className="text-xs text-gray-400 font-black uppercase tracking-widest">{topic.posts} Active Threads</p>
                        </div>
                     </div>
         ...
         <div className="lg:col-span-4 space-y-6">
            <div className="bg-white dark:bg-gray-900 rounded-[2rem] p-8 border border-gray-100 dark:border-gray-800 shadow-sm">
               ...
               <div className="space-y-6">
                  <div className="flex justify-between items-center bg-gray-50 dark:bg-gray-800/50 p-4 rounded-2xl">
                     ...
                     <span className="text-xl font-black">{qaPerformance?.totalMarks || 0}</span>
                  </div>
                  <div className="flex justify-between items-center bg-gray-50 dark:bg-gray-800/50 p-4 rounded-2xl">
                     <span className="text-xs font-black uppercase tracking-widest text-gray-400">Forum Stars</span>
            ...
            <div className="bg-indigo-600 rounded-[2rem] p-8 text-white shadow-xl shadow-indigo-500/20">
               ...
               <h3 className="text-lg font-black tracking-tight mb-2 uppercase text-xs">Verified Experts Only</h3>
