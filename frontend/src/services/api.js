...
export const reportApi = {
  getAll: (params) => api.get('/moderation/reports', { params }).then((res) => res.data),
  create: (data) => api.post('/moderation/reports', data).then((res) => res.data),
  getById: (id) => api.get(`/moderation/reports/${id}`).then((res) => res.data),
  moderate: (id, action, moderatorAction) => api.put(`/moderation/reports/${id}/${action}`, { moderatorAction }).then((res) => res.data),
  delete: (id) => api.delete(`/moderation/reports/${id}`).then((res) => res.data)
};
