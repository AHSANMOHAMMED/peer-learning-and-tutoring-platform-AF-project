...
const NationalMerit = () => {
  ...
  // Real-world Mock Merit Data for Regional Mastery
  const districts = useMemo(() => [
    { rank: 1, name: 'Colombo', score: 9842, engagement: 95, status: 'Leading', trend: '+12%', color: 'blue' },
    { rank: 2, name: 'Gampaha', score: 8521, engagement: 88, status: 'Growing', trend: '+8%', color: 'indigo' },
    { rank: 3, name: 'Kandy', score: 7920, engagement: 82, status: 'Stable', trend: '+4%', color: 'teal' },
    { rank: 4, name: 'Kurunegala', score: 6410, engagement: 74, status: 'Rising', trend: '+15%', color: 'emerald' },
    { rank: 5, name: 'Galle', score: 5840, engagement: 68, status: 'Stable', trend: '+2%', color: 'cyan' },
    { rank: 6, name: 'Kalutara', score: 4920, engagement: 62, status: 'Rising', trend: '+10%', color: 'blue' },
    { rank: 7, name: 'Jaffna', score: 4100, engagement: 55, status: 'Stable', trend: '+5%', color: 'indigo' },
    { rank: 8, name: 'Matara', score: 3850, engagement: 52, status: 'Rising', trend: '+7%', color: 'teal' }
  ], []);

  const topStudents = [
    { name: 'Arjun S.', district: 'Colombo', points: 450, avatar: 'A', stream: 'Combined Maths' },
    { name: 'Dilshan P.', district: 'Kandy', points: 425, avatar: 'D', stream: 'Combined Maths' },
    { name: 'Sameera K.', district: 'Gampaha', points: 410, avatar: 'S', stream: 'Physics' }
  ];
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-200 flex flex-col md:flex-row justify-between items-center gap-6">
             ...
             <div className="w-full md:w-auto relative">
                ...
                <input
                  ...
                  className="w-full md:w-64 pl-10 pr-4 py-2 bg-slate-100 border-none rounded-lg text-sm outline-none focus:ring-2 focus:ring-blue-500 transition-shadow"
                />
             </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
             ...
             <div className="lg:col-span-2 space-y-6">
                <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                   ...
                   <div className="divide-y divide-slate-100">
                      {districts.filter(d => d.name.toLowerCase().includes(searchTerm.toLowerCase())).map((d, i) => (
                   ...
                   {districts.filter(d => d.name.toLowerCase().includes(searchTerm.toLowerCase())).length === 0 && (
             ...
             <div className="space-y-6">
                ...
                <div className="bg-blue-600 rounded-xl p-8 text-white shadow-sm">
                   ...
                   <button className="w-full py-2.5 bg-white text-blue-700 hover:bg-blue-50 rounded-lg font-bold text-sm transition-colors shadow-sm">
                      View My Progress
                   </button>
                </div>
             </div>
