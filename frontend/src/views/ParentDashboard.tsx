...
const ParentDashboard: React.FC = () => {
  ...
  const [selectedStudent, setSelectedStudent] = useState<StudentLink | null>(null);
  ...
  const getStudentDisplayName = (studentObj: any) => {
  ...
  const getStudentInitial = (studentObj: any) => getStudentDisplayName(studentObj).charAt(0).toUpperCase();
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="bg-gray-50 rounded-lg p-6">
                          ...
                          <div className="h-48 flex items-end space-x-1">
                            {Object.entries(progress.dailyActivity).map(([date, count]: [string, any]) => (
                              <div
                                key={date}
                      ...
                      <div>
                        ...
                        {schedule.upcomingSessions.length > 0 || schedule.courses.length > 0 ? (
                          <div className="space-y-4">
                            {schedule.upcomingSessions.map((session: any, index: number) => (
                              <div
                                key={index}
                      ...
                      <div className="space-y-6">
                        ...
                        {studentData?.qaPerformance?.subjectPerformance?.length > 0 && (
                          <div>
                            ...
                            <div className="space-y-3">
                              {studentData.qaPerformance.subjectPerformance.map((item: any) => (
                                <div
                                  key={item.subject}
