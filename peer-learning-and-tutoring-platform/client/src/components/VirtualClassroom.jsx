...
const VirtualClassroom = ({ 
  ...
  const createClassroomEnvironment = (scene, viewType) => {
  ...
  const createTheaterEnvironment = (group) => {
    // Floor
  ...
  const createTraditionalClassroom = (group) => {
  ...
  const createAuditoriumEnvironment = (group) => {
    // Large curved floor
  ...
  const createInstructorArea = (scene) => {
    // Instructor podium
  ...
  const createAvatar = (participant, position) => {
